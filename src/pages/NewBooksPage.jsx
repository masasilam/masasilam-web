// ============================================
// src/pages/NewBooksPage.jsx - WITH COMPLETE SEO
// ============================================
...
const NewBooksPage = () => {
  ...
  const pageUrl = currentPage > 1 ? `/buku/terbaru?page=${currentPage}` : '/buku/terbaru'
  const prevUrl = currentPage > 1 ? (currentPage === 2 ? '/buku/terbaru' : `/buku/terbaru?page=${currentPage - 1}`) : null
  const nextUrl = currentPage < totalPages ? `/buku/terbaru?page=${currentPage + 1}` : null

  return (
    <>
      <SEO
        title="Buku Terbaru - Koleksi Buku Baru Domain Publik"
        description={`Temukan ${totalBooks} buku terbaru yang baru saja ditambahkan ke perpustakaan digital MasasilaM. Update koleksi buku domain publik setiap minggu.`}
        url={pageUrl}
        type="website"
        keywords="buku terbaru, buku baru, koleksi terbaru, update buku, buku domain publik baru"
