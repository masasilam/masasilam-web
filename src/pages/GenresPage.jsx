...
const GenresPage = () => {
  ...
  const totalBooks = genres.reduce((sum, g) => sum + (g.bookCount || 0), 0)
  ...
  return (
    <>
      <SEO
        title="Kategori Buku Domain Publik"
        description={`Jelajahi ${genres.length} kategori buku klasik domain publik dengan total ${totalBooks} buku. Temukan genre favoritmu mulai dari fiksi, non-fiksi, sejarah, hingga ilmu pengetahuan.`}
        url="/kategori"
        type="website"
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 sm:py-12 md:py-16 lg:py-20">
        <div className="container mx-auto px-4 sm:px-6">
          {/* Header Section */}
          <header className="mb-8 sm:mb-10 md:mb-12 pb-6 border-b-2 border-primary">
                  ...
                  >
                    ...
                    <div className="relative flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <h2 className="text-base sm:text-lg font-bold mb-2 text-gray-900 dark:text-white group-hover:text-primary transition-colors line-clamp-1">
                          {genre.name}
                        </h2>
                        {genre.description && (
