...
const DashboardOverview = () => {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Lacak progres membaca, statistik, dan pencapaian Anda')
    }
  ...
  if (error) {
    return <div className="text-red-500 text-center py-8" role="alert">{error}</div>
  }
      ...
      <div className="space-y-6 sm:space-y-8">
        ...
        <div className="bg-gradient-to-r from-primary to-purple-500 rounded-lg p-6 sm:p-8 text-white shadow-xl">
          ...
          <p className="opacity-90 text-sm sm:text-base">
            {stats.currentStreak > 0 ? `Streak ${stats.currentStreak} hari! 🔥` : 'Mulai membaca hari ini'}
          </p>
        </div>
          ...
          <section className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 sm:p-6">
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                ...
                <span className="font-semibold text-sm sm:text-base">{pattern.preferredReadingTime || '-'}</span>
              </div>
              <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div className="flex items-center gap-3">
                ...
                <span className="font-semibold text-sm sm:text-base">{pattern.averageReadingSpeedWpm || 0} wpm</span>
              </div>
              <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div className="flex items-center gap-3">
                ...
                <span className="font-semibold text-sm sm:text-base">{pattern.averageSessionMinutes || 0} menit</span>
              </div>
              <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div className="flex items-center gap-3">
                ...
                <span className="font-semibold text-sm sm:text-base">{pattern.readingPace || '-'}</span>
              </div>
            </div>
          </section>
        </div>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <span className={`inline-block px-2 py-0.5 text-xs rounded ${
                      r.activityType === 'completed' ? 'bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300' :
                      r.activityType === 'started' ? 'bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300' :
