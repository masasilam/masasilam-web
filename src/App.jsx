...
import { isYearSegment } from './utils/newspaperUtils'
...
import NewspaperSourceDetailPage from './pages/NewspaperSourceDetailPage'
import NewspaperYearPage from './pages/NewspaperYearPage'
import NewspaperEditionPage from './pages/NewspaperEditionPage'
import NewspaperRubrikPage from './pages/NewspaperRubrikPage'
...
const NewspaperSecondSegment = () => {
  const { second } = useParams()
  return isYearSegment(second) ? <NewspaperYearPage /> : <NewspaperArticleDetailPage />
}
  ...
  return (
    <div className="app">
      ...
      <Routes>
        ...
        <Route path="/koran" element={<PublicLayout><NewspaperHomePage /></PublicLayout>} />
        ...
        <Route path="/sosial" element={<PublicLayout><SocialLayout /></PublicLayout>}>
